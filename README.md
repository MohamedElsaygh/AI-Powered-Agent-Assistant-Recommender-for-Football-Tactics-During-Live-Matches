You can find the data in this path
Check out the [AI Agent for Football Tactics](https://github.com/MohamedElsaygh/AI-Agent-For-Football-Tactics-During-Live-Matches).
